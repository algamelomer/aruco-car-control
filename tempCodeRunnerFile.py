...
class ArucoMarkers(): 
    ...
    # Detect multiple ArUco markers and estimate pose
        # Detect multiple ArUco markers and estimate pose
    def aruco_marker_pose_estimation(self, aruco_type, camera_matrix, dist_coeffs, cam): 
...
def run_aruco_marker_pose_estimation(aruco_type): 
    ...
    aruco_marker.aruco_marker_pose_estimation(aruco_type, camera_matrix, dist_coeffs, 0)
